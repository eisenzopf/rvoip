...
All 38 publishable workspace crates use `[workspace.package].version` and ship
...
workspace inventory other than the expected 38 publishable packages. It
...
After all 38 versions are visible, create the annotated tag and GitHub release:
