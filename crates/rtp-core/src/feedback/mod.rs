...
impl FeedbackGeneratorFactory {
    ...
    pub fn create_comprehensive_generator() -> Box<dyn FeedbackGenerator> {
        Box::new(generators::ComprehensiveFeedbackGenerator::new())
    }
} 