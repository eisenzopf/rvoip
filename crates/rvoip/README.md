...
> **Unified `0.3.10` release train.** The `sip` feature is the release-gated beta
...
> the exact clean `0.3.10` release source; historical exception and
...
rvoip = { version = "0.3.10", default-features = false, features = ["bundle-full-pure-rust"] }
```
...
```toml
[dependencies]
rvoip = { version = "0.3.10", features = ["sip"] }
...
These products ship in the unified `0.3.10` train but are intentionally not
