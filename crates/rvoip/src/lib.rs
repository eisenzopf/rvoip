...
//! - **Dialog Core**: SIP dialog state management (includes transaction layer)
...
//! - [`dialog_core`]: Dialog state management (includes transaction layer)
...
pub mod prelude {
    ...
    //! - [`crate::dialog_core`] - Dialog state management (includes transaction layer)
