...
mod tests {
    ...
    use crate::ClientTransaction;
    use crate::client::{ClientInviteTransaction, ClientNonInviteTransaction};
    use crate::error::{Error, Result};
    use crate::manager::RFC3261_BRANCH_MAGIC_COOKIE;
    ...
    async fn test_socket_addr_from_uri() {
        use crate::manager::utils::socket_addr_from_uri;
    ...
    async fn test_get_transaction_request() -> Result<()> {
        use crate::manager::utils::get_transaction_request;
