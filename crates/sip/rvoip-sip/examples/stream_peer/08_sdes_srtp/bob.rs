//! SDES-SRTP answerer (Bob) — mandatory RFC 4568 SDES key exchange.
//!
//! Run standalone:  cargo run -p rvoip-sip --example stream_peer_sdes_srtp_bob
//! Or with alice:    ./examples/stream_peer/08_sdes_srtp/run.sh
...
async fn main() -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    println!("[bob] waiting for SDES-SRTP negotiation...");
