...
- role: caller
- codec: default
- started_at_utc: 2026-08-12T06:31:54Z
- output_dir: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/reject/TLS
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/reject/TLS/caller.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=reject PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=caller PBX_CODEC_PROFILE=default AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/reject/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_endpoint
```
