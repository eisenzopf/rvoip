...
- role: target
- codec: default
- started_at_utc: 2026-08-12T06:32:14Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/blind_transfer/TLS/target.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=blind_transfer PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=target PBX_CODEC_PROFILE=default AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/blind_transfer/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_endpoint
```
