...
- role: caller
- codec: amrnb_be
- started_at_utc: 2026-08-12T06:30:02Z
...
```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=amr_call PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=caller PBX_CODEC_PROFILE=amrnb_be AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/amr_call/amrnb_be/UDP /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_endpoint
```
