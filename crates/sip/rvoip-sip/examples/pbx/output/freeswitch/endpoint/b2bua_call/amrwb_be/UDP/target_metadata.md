...
- role: target
- codec: amrwb_be
- started_at_utc: 2026-08-12T06:30:47Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/b2bua_call/amrwb_be/UDP/target.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=b2bua_call PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=target PBX_CODEC_PROFILE=amrwb_be AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/b2bua_call/amrwb_be/UDP /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_endpoint
```
