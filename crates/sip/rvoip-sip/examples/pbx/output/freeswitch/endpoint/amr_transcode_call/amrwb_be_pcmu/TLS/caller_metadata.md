...
- role: caller
- codec: amrwb_be_pcmu
- started_at_utc: 2026-08-12T02:06:00Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/amr_transcode_call/amrwb_be_pcmu/TLS/caller.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=amr_transcode_call PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=caller PBX_CODEC_PAIRING=amrwb_be_pcmu AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/amr_transcode_call/amrwb_be_pcmu/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_endpoint
```
