...
- role: target
- codec: pcmu
- started_at_utc: 2026-08-12T06:30:40Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/b2bua_call/pcmu/TLS/target.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=b2bua_call PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=target PBX_CODEC_PROFILE=pcmu AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/endpoint/b2bua_call/pcmu/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_endpoint
```
