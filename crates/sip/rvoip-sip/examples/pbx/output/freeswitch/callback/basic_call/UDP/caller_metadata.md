...
- role: caller
- codec: default
- started_at_utc: 2026-08-12T06:35:24Z
- output_dir: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/callback/basic_call/UDP
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/callback/basic_call/UDP/caller.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=basic_call PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=caller PBX_CODEC_PROFILE=default AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/callback/basic_call/UDP /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_callback_builder
```
