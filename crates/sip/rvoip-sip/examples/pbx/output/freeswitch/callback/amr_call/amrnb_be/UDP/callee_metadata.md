...
- role: callee
- codec: amrnb_be
- started_at_utc: 2026-08-12T06:36:01Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/callback/amr_call/amrnb_be/UDP/callee.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=amr_call PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=callee PBX_CODEC_PROFILE=amrnb_be AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/callback/amr_call/amrnb_be/UDP /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_callback_builder
```
