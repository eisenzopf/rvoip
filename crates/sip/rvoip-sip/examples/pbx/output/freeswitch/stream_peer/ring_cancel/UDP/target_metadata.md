...
- role: target
- codec: default
- started_at_utc: 2026-08-12T06:34:15Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/ring_cancel/UDP/target.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=ring_cancel PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=target PBX_CODEC_PROFILE=default AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/ring_cancel/UDP /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
