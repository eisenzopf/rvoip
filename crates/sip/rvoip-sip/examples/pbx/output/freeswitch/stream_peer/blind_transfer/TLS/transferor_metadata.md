...
- role: transferor
- codec: default
- started_at_utc: 2026-08-12T06:35:02Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/blind_transfer/TLS/transferor.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=blind_transfer PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=transferor PBX_CODEC_PROFILE=default AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/blind_transfer/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
