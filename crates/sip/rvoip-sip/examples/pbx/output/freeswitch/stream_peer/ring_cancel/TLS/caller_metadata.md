...
- role: caller
- codec: default
- started_at_utc: 2026-08-12T06:34:19Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/ring_cancel/TLS/caller.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=ring_cancel PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=caller PBX_CODEC_PROFILE=default AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/ring_cancel/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
