...
- role: callee
- codec: default
- started_at_utc: 2026-08-12T06:33:46Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/hold_resume/UDP/callee.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=hold_resume PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=callee PBX_CODEC_PROFILE=default AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/hold_resume/UDP /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
