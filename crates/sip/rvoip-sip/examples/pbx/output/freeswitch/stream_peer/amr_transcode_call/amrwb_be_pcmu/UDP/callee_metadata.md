...
- role: callee
- codec: amrwb_be_pcmu
- started_at_utc: 2026-08-12T06:33:35Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/amr_transcode_call/amrwb_be_pcmu/UDP/callee.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=amr_transcode_call PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=callee PBX_CODEC_PAIRING=amrwb_be_pcmu AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/amr_transcode_call/amrwb_be_pcmu/UDP /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
