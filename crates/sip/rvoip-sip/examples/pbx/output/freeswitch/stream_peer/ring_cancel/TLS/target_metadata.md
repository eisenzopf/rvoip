...
- provider: freeswitch
- api: stream_peer
- scenario: ring_cancel
- transport: TLS
- role: target
- codec: default
- started_at_utc: 2026-08-12T06:34:18Z
- output_dir: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/ring_cancel/TLS
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/ring_cancel/TLS/target.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=ring_cancel PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=target PBX_CODEC_PROFILE=default AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/ring_cancel/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
