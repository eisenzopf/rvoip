...
- role: callee
- codec: amrnb_be_pcmu
- started_at_utc: 2026-08-12T06:33:30Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/amr_transcode_call/amrnb_be_pcmu/TLS/callee.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=amr_transcode_call PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=callee PBX_CODEC_PAIRING=amrnb_be_pcmu AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/amr_transcode_call/amrnb_be_pcmu/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
