...
- provider: freeswitch
- api: stream_peer
- scenario: hold_resume
- transport: TLS
- role: caller
- codec: default
- started_at_utc: 2026-08-12T06:34:01Z
- output_dir: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/hold_resume/TLS
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/hold_resume/TLS/caller.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=hold_resume PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=caller PBX_CODEC_PROFILE=default AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/hold_resume/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
