...
- role: callee
- codec: default
- started_at_utc: 2026-08-12T06:34:00Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/hold_resume/TLS/callee.log

## Command

```sh
PBX_PROVIDER=freeswitch PBX_SCENARIO=hold_resume PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=callee PBX_CODEC_PROFILE=default AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/freeswitch/stream_peer/hold_resume/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
