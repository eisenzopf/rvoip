...
- role: callee
- codec: amrnb
- started_at_utc: 2026-08-12T06:18:36Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/asterisk/stream_peer/amr_call/amrnb/TLS/callee.log

## Command

```sh
PBX_PROVIDER=asterisk PBX_SCENARIO=amr_call PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=callee PBX_CODEC_PROFILE=amrnb AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/asterisk/stream_peer/amr_call/amrnb/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
