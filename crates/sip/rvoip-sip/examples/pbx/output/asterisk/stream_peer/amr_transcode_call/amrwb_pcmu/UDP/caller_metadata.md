...
- role: caller
- codec: amrwb_pcmu
- started_at_utc: 2026-08-12T06:19:02Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/asterisk/stream_peer/amr_transcode_call/amrwb_pcmu/UDP/caller.log

## Command

```sh
PBX_PROVIDER=asterisk PBX_SCENARIO=amr_transcode_call PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=caller PBX_CODEC_PAIRING=amrwb_pcmu AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/asterisk/stream_peer/amr_transcode_call/amrwb_pcmu/UDP /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_stream_peer
```
