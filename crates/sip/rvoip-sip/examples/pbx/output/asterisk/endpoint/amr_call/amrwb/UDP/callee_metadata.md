...
- role: callee
- codec_profile: amrwb
- started_at_utc: 2026-08-11T20:08:37Z
...
```sh
PBX_PROVIDER=asterisk PBX_SCENARIO=amr_call PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=callee PBX_CODEC_PROFILE=amrwb AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/asterisk/endpoint/amr_call/amrwb/UDP /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_endpoint
```
