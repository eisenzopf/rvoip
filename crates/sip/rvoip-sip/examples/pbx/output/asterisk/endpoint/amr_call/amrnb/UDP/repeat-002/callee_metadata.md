...
- role: callee
- codec: amrnb
- started_at_utc: 2026-08-12T02:03:37Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/asterisk/endpoint/amr_call/amrnb/UDP/repeat-002/callee.log

## Command

```sh
PBX_PROVIDER=asterisk PBX_SCENARIO=amr_call PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=callee PBX_CODEC_PROFILE=amrnb AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/asterisk/endpoint/amr_call/amrnb/UDP/repeat-002 /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_endpoint
```
