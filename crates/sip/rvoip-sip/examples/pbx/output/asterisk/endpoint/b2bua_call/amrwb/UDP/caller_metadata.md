...
- role: caller
- codec: amrwb
- started_at_utc: 2026-08-12T04:38:29Z
...
- log: /Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/asterisk/endpoint/b2bua_call/amrwb/UDP/caller.log

## Command

```sh
PBX_PROVIDER=asterisk PBX_SCENARIO=b2bua_call PBX_TRANSPORT=UDP SIP_TRANSPORT=UDP PBX_ROLE=caller PBX_CODEC_PROFILE=amrwb AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/asterisk/endpoint/b2bua_call/amrwb/UDP /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_endpoint
```
