...
```sh
PBX_PROVIDER=asterisk PBX_SCENARIO=b2bua_call PBX_TRANSPORT=TLS SIP_TRANSPORT=TLS PBX_ROLE=caller PBX_CODEC_PROFILE=amrwb AUDIO_OUTPUT_DIR=/Users/jonathan/Developer/rvoip/crates/sip/rvoip-sip/examples/pbx/output/asterisk/endpoint/b2bua_call/amrwb/TLS /Users/jonathan/Developer/rvoip/target/debug/examples/pbx_endpoint
```
