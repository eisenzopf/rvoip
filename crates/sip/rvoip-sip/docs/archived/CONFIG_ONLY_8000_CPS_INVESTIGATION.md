...
Results from
`crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_parse_fanout_20260523_114126`:
...
Results from
`crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_tx_dispatch_signaling_matrix_20260523_133215`:
...
`crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_tx_udp_combined_20260523_133412`:
...
`crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_tx_fanout_10k_20260523_134716`:
...
`crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_tx_breakpoint_sweep_20260523_140211`:
...
`crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_tx_breakpoint_18k_compare_20260523_140727`,
`crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_tx_breakpoint_18k_workers_20260523_140836`,
and
`crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_tx_breakpoint_18k_tx4_repeat_20260523_140945`:
...
`crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_tx_breakpoint_20k_workers_20260523_140406`:
...
- `crates/sip/rvoip-sip/src/api/builder.rs`
- `crates/sip/rvoip-sip/src/api/stream_peer.rs`
- `crates/sip/rvoip-sip/src/api/callback_peer.rs`
...
`crates/sip/rvoip-sip/examples/perf_listener.rs` now builds this profile by
default:
...
rg -n 'RVOIP_PERF_CHANNEL_CAPACITY|RVOIP_PERF_SERVER_CAPACITY|RVOIP_PERF_SIP_UDP_PARSE|RVOIP_PERF_AUTO_180|RVOIP_PERF_MEDIA_ENABLED|RVOIP_PERF_RTP_PORT|RVOIP_PERF_MEDIA_PORT|RVOIP_PERF_SUPPRESS_AUTO_180|RVOIP_SIP_UDP_PARSE_WORKERS|RVOIP_SIP_UDP_PARSE_QUEUE_CAPACITY|RVOIP_PERF_NO_MEDIA|RVOIP_PERF_NO_MEDIA_RTP_PORT' \
  crates/sip/rvoip-sip/examples/perf_listener.rs \
  crates/sip/rvoip-sip/tests/perf/perf_call_setup_cps.rs \
  crates/sip/rvoip-sip/src \
  crates/sip/rvoip-sip-dialog/src \
  crates/sip/rvoip-sip-transport/src \
  crates/media/media-core/src \
  crates/media/rtp-core/src
```
...
`crates/sip/rvoip-sip/tests/perf/perf_call_setup_cps.rs` now uses:
...
- `crates/sip/rvoip-sip/tests/config_channel_capacity_integration.rs`
- `crates/sip/rvoip-sip/tests/config_tests.rs`
...
```bash
RVOIP_PERF_RESULTS=crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/config_only_8000_$(date +%Y%m%d_%H%M%S) \
RVOIP_PERF_CPS=8000 \
RVOIP_PERF_STEADY_SECS=15 \
RVOIP_PERF_SIPP_SHARD_CPS=1000 \
RVOIP_PERF_TRACE_SCREEN=0 \
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/run_comparison_dockerized.sh \
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_config_audit_8000_20260523_015707
```
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_auto100_off_config_20260523_023519
```
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_auto100_off_diag_20260523_023707
```
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_fast_accept_inline_8000_20260523_020958
```
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_fused_fast200_diag_20260523_030156
```
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_fused_fast200_prod_20260523_030413
```
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_lossless_fast200_diag_20260523_033611
```
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_lossless_fast200_prod_20260523_033753
```
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/codex_lossless_default_prod_20260523_033927
```
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/config_only_8000_20260523_003707
```
...
```text
crates/sip/rvoip-sip/tests/perf/sipp_scenarios/results/config_only_diag_8000_20260523_004058
```
...
- `crates/sip/rvoip-sip/tests/perf/perf_call_setup_cps.rs`
- `crates/sip/rvoip-sip/tests/perf/sipp_scenarios/run_comparison_dockerized.sh`
- `crates/sip/rvoip-sip/tests/perf/sipp_scenarios/uac_perf.xml`
...
- `crates/sip/rvoip-sip-transport/src/diagnostics.rs`
- `crates/sip/rvoip-sip-dialog/src/diagnostics.rs`
- `crates/media/media-core/src/diagnostics.rs`

### BYE Handling

- `crates/sip/rvoip-sip/src/state_table/wiring_manifest.rs`
  - documents that dialog-core sends BYE `200 OK`; session-core only
    cleans up.
- `crates/sip/rvoip-sip-dialog/src/manager/protocol_handlers.rs`
- `crates/sip/rvoip-sip-dialog/src/manager/transaction_integration.rs`
