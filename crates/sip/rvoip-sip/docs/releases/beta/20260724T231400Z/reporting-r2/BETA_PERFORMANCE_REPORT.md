...
- Canonical 2K evidence: three clean passes from the tested source and common executable, including absolute setup and full-cycle p50/p95/p99 limits.
- Performance-regression latency tolerance: no more than 25% above the reviewed baseline.
...
|---:|---|---:|---:|---:|---:|---:|---:|---|
| 1 | Call setup | 0.636 | ≤ 13.970 | 0.962 | ≤ 15.360 | 1.288 | ≤ 16.690 | PASS |
| 1 | Full call cycle | 1.016 | ≤ 154.660 | 1.443 | ≤ 156.880 | 2.130 | ≤ 159.660 | PASS |
| 2 | Call setup | 0.648 | ≤ 13.970 | 0.984 | ≤ 15.360 | 1.307 | ≤ 16.690 | PASS |
| 2 | Full call cycle | 1.028 | ≤ 154.660 | 1.456 | ≤ 156.880 | 2.064 | ≤ 159.660 | PASS |
| 3 | Call setup | 0.737 | ≤ 13.970 | 1.157 | ≤ 15.360 | 1.518 | ≤ 16.690 | PASS |
| 3 | Full call cycle | 1.171 | ≤ 154.660 | 1.737 | ≤ 156.880 | 2.408 | ≤ 159.660 | PASS |

## Complete call-setup profile matrix

Latency columns are observed milliseconds. Matrix points without a separate absolute latency limit remain subject to the recorded ASR, throughput, cleanup, and applicable regression gates; they are not silently presented as latency-SLA passes.

| Profile | Target CPS | Achieved CPS | ASR | Setup p50 | Setup p95 | Setup p99 | Cycle p50 | Cycle p95 | Cycle p99 | Calls |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `endpoint` | 30.0 | 27.86 | 1.0 | 4.866 | 7.422 | 9.232 | 7.066 | 9.748 | 11.256 | 975/975 |
| `pbx-media-server` | 30.0 | 27.86 | 1.0 | 4.854 | 6.459 | 7.733 | 6.808 | 8.765 | 10.142 | 975/975 |
| `pbx-media-server` | 100.0 | 92.85 | 1.0 | 2.497 | 3.916 | 4.899 | 3.121 | 4.772 | 6.406 | 3250/3250 |
| `pbx-media-server` | 300.0 | 278.56 | 1.0 | 0.958 | 3.023 | 3.838 | 1.486 | 3.662 | 4.596 | 9750/9750 |
| `pbx-media-server` | 1000.0 | 928.53 | 1.0 | 0.616 | 0.826 | 0.990 | 0.961 | 1.196 | 1.520 | 32500/32500 |
| `pbx-media-server` | 2000.0 | 1857.12 | 1.0 | 0.627 | 0.918 | 1.157 | 0.996 | 1.341 | 1.823 | 65000/65000 |
| `signaling-only-server-high-performance` | 30.0 | 27.86 | 1.0 | 3.707 | 4.911 | 6.623 | 5.665 | 7.463 | 13.697 | 975/975 |
| `signaling-only-server-high-performance` | 100.0 | 92.85 | 1.0 | 2.558 | 3.740 | 4.649 | 3.195 | 4.633 | 6.296 | 3250/3250 |
| `signaling-only-server-high-performance` | 300.0 | 278.56 | 1.0 | 0.895 | 2.968 | 3.652 | 1.414 | 3.699 | 4.481 | 9750/9750 |
| `signaling-only-server-high-performance` | 1000.0 | 928.56 | 1.0 | 0.609 | 0.790 | 0.944 | 0.972 | 1.188 | 1.476 | 32500/32500 |
| `signaling-only-server-high-performance` | 2000.0 | 1857.07 | 1.0 | 0.616 | 0.848 | 1.012 | 1.000 | 1.281 | 1.483 | 65000/65000 |
...
- Result: **PASS**.
- Latency limit: reviewed baseline plus at most 25%.

| Scenario | Measurement | Percentile | Baseline ms | Limit ms | Observed ms | Result |
|---|---|---|---:|---:|---:|---|
| `perf_call_setup_cps_pbx-media-server/2000` | Call setup | p50 | 11.174 | ≤ 13.967 | 0.627 | PASS |
| `perf_call_setup_cps_pbx-media-server/2000` | Call setup | p95 | 12.288 | ≤ 15.360 | 0.918 | PASS |
| `perf_call_setup_cps_pbx-media-server/2000` | Call setup | p99 | 13.353 | ≤ 16.691 | 1.157 | PASS |
| `perf_call_setup_cps_pbx-media-server/2000` | Full call cycle | p50 | 123.732 | ≤ 154.665 | 0.996 | PASS |
| `perf_call_setup_cps_pbx-media-server/2000` | Full call cycle | p95 | 125.501 | ≤ 156.877 | 1.341 | PASS |
| `perf_call_setup_cps_pbx-media-server/2000` | Full call cycle | p99 | 127.730 | ≤ 159.662 | 1.823 | PASS |
