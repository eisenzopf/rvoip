...
pub const EVENT_WIRINGS: &[EventWiring] = &[
    ...
    EventWiring {
        ...
        actions: &["SendREGISTER", "SendREGISTERWithOptions", "SendREGISTERWithAuth"],
        kind: WiringKind::StateTable,
    ...
    EventWiring {
        ...
        event_type: "n/a",
        yaml_event: "n/a",
        actions: &["DialogAdapter::send_message_oob_with_options"],
        kind: WiringKind::Direct,
        notes: "Public OOB MESSAGE bypasses the state table by design.",
    },
    EventWiring {
    ...
    EventWiring {
        ...
        event_type: "n/a",
        yaml_event: "n/a",
        actions: &["DialogAdapter::send_options_oob_with_options"],
        kind: WiringKind::Direct,
        notes: "Public OOB OPTIONS bypasses the state table by design.",
    },
    EventWiring {
    ...
    EventWiring {
        ...
        event_type: "n/a",
        yaml_event: "n/a",
        actions: &["DialogAdapter::send_subscribe_oob_with_options"],
        kind: WiringKind::DialogManaged,
        notes: "Subscription sends are direct-wired; NOTIFY delivery is handled by dialog-core/session events.",
    },
    EventWiring {
        sip_message: "PUBLISH",
