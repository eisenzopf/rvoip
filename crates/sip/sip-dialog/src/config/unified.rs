...
//!
//! ```rust
//! use rvoip_sip_dialog::config::unified::{DialogManagerConfig, ClientBehavior};
//! use rvoip_sip_dialog::api::{DialogConfig, Credentials};
//!
...
//!
//! ```rust
//! use rvoip_sip_dialog::config::unified::{DialogManagerConfig, ServerBehavior};
//! use rvoip_sip_dialog::api::DialogConfig;
//!
...
//!
//! ```rust
//! use rvoip_sip_dialog::config::unified::{DialogManagerConfig, HybridBehavior};
//! use rvoip_sip_dialog::api::{DialogConfig, Credentials};
//!
...
///
/// ```rust
/// use rvoip_sip_dialog::config::unified::DialogManagerConfig;
///
