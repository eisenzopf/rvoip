...
//!
//! ```rust,no_run
//! use rvoip_sip_dialog::api::common::DialogHandle;
...
//!
//! ```rust,no_run
//! use rvoip_sip_dialog::api::common::CallHandle;
//!
...
//!
//! ```rust,no_run
//! use rvoip_sip_dialog::api::common::DialogEvent;
//!
...
impl DialogHandle {
    ...
    pub async fn state(&self) -> ApiResult<DialogState> {
        self.dialog_manager
            .get_dialog_state(&self.dialog_id)
            .map_err(ApiError::from)
    }
    ...
    pub async fn send_request(&self, method: Method, body: Option<String>) -> ApiResult<String> {
        ...
        let transaction_key = self
            .dialog_manager
            .send_request(&self.dialog_id, method, body_bytes)
            .await
            .map_err(ApiError::from)?;
    ...
    /// # Returns
    /// Transaction key for tracking the request
    pub async fn send_request_with_key(
        &self,
        method: Method,
    ...
    pub async fn send_refer(
        ...
        self.send_request_with_key(Method::Refer, Some(bytes::Bytes::from(body)))
            .await
    }
    ...
    pub async fn send_update(&self, sdp: Option<String>) -> ApiResult<TransactionKey> {
        ...
        self.send_request_with_key(Method::Update, update_body)
            .await
    }
    ...
    pub async fn terminate(&self) -> ApiResult<()> {
        ...
        // Terminate dialog
        self.dialog_manager
            .terminate_dialog(&self.dialog_id)
            .await
            .map_err(ApiError::from)?;
...
impl CallHandle {
    ...
    pub async fn hold(&self, hold_sdp: Option<String>) -> ApiResult<()> {
        ...
        self.dialog_handle
            .send_request(Method::Invite, hold_sdp)
            .await?;
    ...
    pub async fn resume(&self, resume_sdp: Option<String>) -> ApiResult<()> {
        ...
        self.dialog_handle
            .send_request(Method::Invite, resume_sdp)
            .await?;
    ...
    pub async fn transfer_with_body(
        &self,
        ...
        self.dialog_handle
            .send_refer(transfer_target, Some(refer_body))
            .await
    }
    ...
    pub async fn send_request(
        ...
        self.dialog_handle
            .send_request_with_key(method, body.map(|s| bytes::Bytes::from(s)))
            .await
    }
...
///
/// ```rust,no_run
/// use rvoip_sip_dialog::api::common::{CallHandle, CallInfo};
/// use rvoip_sip_dialog::dialog::DialogState;
///
/// # async fn example(call: CallHandle) -> Result<(), Box<dyn std::error::Error>> {
/// let info = call.info().await?;
...
/// ```rust,no_run
/// use rvoip_sip_dialog::api::common::DialogEvent;
/// use rvoip_sip_dialog::dialog::{DialogId, DialogState};
///
