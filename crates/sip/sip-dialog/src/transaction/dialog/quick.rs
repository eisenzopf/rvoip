...
/// # Example
/// ```rust,no_run
/// use rvoip_sip_dialog::transaction::dialog::quick::bye_for_dialog;
/// use std::net::SocketAddr;
///
...
/// # Example
/// ```rust,no_run
/// use rvoip_sip_dialog::transaction::dialog::quick::refer_for_dialog;
/// use std::net::SocketAddr;
///
/// # fn main() -> Result<(), Box<dyn std::error::Error>> {
/// let local_addr: SocketAddr = "127.0.0.1:5060".parse().unwrap();
...
/// # Example
/// ```rust,no_run
/// use rvoip_sip_dialog::transaction::dialog::quick::update_for_dialog;
/// use std::net::SocketAddr;
///
/// # fn main() -> Result<(), Box<dyn std::error::Error>> {
/// let local_addr: SocketAddr = "127.0.0.1:5060".parse().unwrap();
...
/// # Example
/// ```rust,no_run
/// use rvoip_sip_dialog::transaction::dialog::quick::info_for_dialog;
/// use std::net::SocketAddr;
///
/// # fn main() -> Result<(), Box<dyn std::error::Error>> {
/// let local_addr: SocketAddr = "127.0.0.1:5060".parse().unwrap();
...
/// # Example
/// ```rust,no_run
/// use rvoip_sip_dialog::transaction::dialog::quick::notify_for_dialog;
/// use std::net::SocketAddr;
///
/// # fn main() -> Result<(), Box<dyn std::error::Error>> {
/// let local_addr: SocketAddr = "127.0.0.1:5060".parse().unwrap();
...
/// # Example
/// ```rust,no_run
/// use rvoip_sip_dialog::transaction::dialog::quick::message_for_dialog;
/// use std::net::SocketAddr;
///
/// # fn main() -> Result<(), Box<dyn std::error::Error>> {
/// let local_addr: SocketAddr = "127.0.0.1:5060".parse().unwrap();
...
/// # Example
/// ```rust,no_run
/// use rvoip_sip_dialog::transaction::dialog::quick::reinvite_for_dialog;
/// use std::net::SocketAddr;
///
/// # fn main() -> Result<(), Box<dyn std::error::Error>> {
/// let local_addr: SocketAddr = "127.0.0.1:5060".parse().unwrap();
...
/// # Example
/// ```rust,no_run
/// use rvoip_sip_dialog::transaction::dialog::quick::response_for_dialog_transaction;
