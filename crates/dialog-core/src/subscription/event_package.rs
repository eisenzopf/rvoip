...
impl EventPackage for DialogPackage {
    ...
    fn accept_types(&self) -> Vec<ContentType> {
        vec![ContentType::from_str("application/dialog-info+xml").unwrap()]
    }
...
impl EventPackage for MessageSummaryPackage {
    ...
    fn accept_types(&self) -> Vec<ContentType> {
        vec![ContentType::from_str("application/simple-message-summary").unwrap()]
    }
...
impl EventPackage for ReferPackage {
    ...
    fn accept_types(&self) -> Vec<ContentType> {
        vec![ContentType::from_str("message/sipfrag").unwrap()]
    }
