...
impl MultiDialogExample {
    ...
    async fn create_multiple_dialogs(
        &self,
    ) -> Result<Vec<rvoip_sip_dialog::api::common::DialogHandle>, Box<dyn std::error::Error>> {
    ...
    async fn make_multiple_calls(
        &self,
    ) -> Result<Vec<rvoip_sip_dialog::api::common::CallHandle>, Box<dyn std::error::Error>> {
    ...
    async fn perform_dialog_operations(
        &self,
        _dialogs: &[rvoip_sip_dialog::api::common::DialogHandle],
