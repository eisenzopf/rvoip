...
use rvoip_sip_dialog::{config::DialogManagerConfig, UnifiedDialogApi};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!(
        ...
        api.supports_outgoing_calls()
    );
    info!(
        "   • Supports incoming calls: {}",
        api.supports_incoming_calls()
    );
    ...
    info!(
        "✅ Statistics: {} active dialogs, {} total",
    ...
    info!(
        "   • Supports outgoing calls: {}",
        server_config.supports_outgoing_calls()
    );
    info!(
        "   • Supports incoming calls: {}",
        server_config.supports_incoming_calls()
    );
    info!(
        "   • Auto OPTIONS: {}",
        server_config.auto_options_enabled()
    );
    ...
    info!(
        "   • Supports outgoing calls: {}",
        hybrid_config.supports_outgoing_calls()
    );
    info!(
        "   • Supports incoming calls: {}",
        hybrid_config.supports_incoming_calls()
    );
    info!(
        "   • Auto OPTIONS: {}",
        hybrid_config.auto_options_enabled()
    );
