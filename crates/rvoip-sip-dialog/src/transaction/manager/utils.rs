...
pub trait ResponseBuilderExt {
    ...
    /// ```no_run
    /// # use rvoip_sip_core::prelude::*;
    /// # use rvoip_sip_dialog::transaction::manager::utils::ResponseBuilderExt;
    /// # fn example(request: &Request) -> rvoip_sip_dialog::transaction::error::Result<Response> {
...
/// # use rvoip_sip_dialog::transaction::manager::utils::socket_addr_from_uri;
/// # fn example() {
...
/// # use rvoip_sip_dialog::transaction::manager::utils::extract_cseq;
...
/// # use rvoip_sip_dialog::transaction::manager::utils::determine_ack_destination;
