...
mod real {
    ...
    static AUDIO_TX_PACING_EVALUATED_COUNT: AtomicU64 = AtomicU64::new(0);
    ...
    static AUDIO_TX_PACING_CONSECUTIVE_SKIP_MAX: AtomicU64 = AtomicU64::new(0);
    ...
    static AUDIO_RX_PACKET_COUNT: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_SEQUENCE_GAP_COUNT: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_SEQUENCE_GAP_PACKETS: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_SEQUENCE_GAP_MAX_PACKETS: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_INTERARRIVAL_GAP_COUNT: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_INTERARRIVAL_GAP_NS: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_INTERARRIVAL_GAP_MAX_NS: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_JITTER_MAX_NS: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_DECODED_FRAME_COUNT: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_DELIVERED_FRAME_COUNT: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_DELIVERED_GAP_COUNT: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_DELIVERED_GAP_NS: AtomicU64 = AtomicU64::new(0);
    static AUDIO_RX_DELIVERED_GAP_MAX_NS: AtomicU64 = AtomicU64::new(0);
    ...
    pub struct Snapshot {
        ...
        pub audio_rx_packet_count: u64,
        pub audio_rx_sequence_gap_count: u64,
        pub audio_rx_sequence_gap_packets: u64,
        pub audio_rx_sequence_gap_max_packets: u64,
        pub audio_rx_interarrival_gap_count: u64,
        pub audio_rx_interarrival_gap_ns: u64,
        pub audio_rx_interarrival_gap_max_ns: u64,
        pub audio_rx_jitter_max_ns: u64,
        pub audio_rx_decoded_frame_count: u64,
        pub audio_rx_delivered_frame_count: u64,
        pub audio_rx_delivered_gap_count: u64,
        pub audio_rx_delivered_gap_ns: u64,
        pub audio_rx_delivered_gap_max_ns: u64,
    }
    ...
    pub fn snapshot() -> Snapshot {
        Snapshot {
            ...
            audio_tx_pacing_evaluated_count: AUDIO_TX_PACING_EVALUATED_COUNT
            ...
            audio_tx_pacing_consecutive_skip_max: AUDIO_TX_PACING_CONSECUTIVE_SKIP_MAX
                .load(Ordering::Relaxed),
            ...
            audio_rx_packet_count: AUDIO_RX_PACKET_COUNT.load(Ordering::Relaxed),
            audio_rx_sequence_gap_count: AUDIO_RX_SEQUENCE_GAP_COUNT.load(Ordering::Relaxed),
            audio_rx_sequence_gap_packets: AUDIO_RX_SEQUENCE_GAP_PACKETS.load(Ordering::Relaxed),
            audio_rx_sequence_gap_max_packets: AUDIO_RX_SEQUENCE_GAP_MAX_PACKETS
                .load(Ordering::Relaxed),
            audio_rx_interarrival_gap_count: AUDIO_RX_INTERARRIVAL_GAP_COUNT
                .load(Ordering::Relaxed),
            audio_rx_interarrival_gap_ns: AUDIO_RX_INTERARRIVAL_GAP_NS.load(Ordering::Relaxed),
            audio_rx_interarrival_gap_max_ns: AUDIO_RX_INTERARRIVAL_GAP_MAX_NS
                .load(Ordering::Relaxed),
            audio_rx_jitter_max_ns: AUDIO_RX_JITTER_MAX_NS.load(Ordering::Relaxed),
            audio_rx_decoded_frame_count: AUDIO_RX_DECODED_FRAME_COUNT.load(Ordering::Relaxed),
            audio_rx_delivered_frame_count: AUDIO_RX_DELIVERED_FRAME_COUNT.load(Ordering::Relaxed),
            audio_rx_delivered_gap_count: AUDIO_RX_DELIVERED_GAP_COUNT.load(Ordering::Relaxed),
            audio_rx_delivered_gap_ns: AUDIO_RX_DELIVERED_GAP_NS.load(Ordering::Relaxed),
            audio_rx_delivered_gap_max_ns: AUDIO_RX_DELIVERED_GAP_MAX_NS.load(Ordering::Relaxed),
        }
    }
    ...
    pub fn format_summary(snapshot: &Snapshot) -> String {
        format!(
         ...
         audio_tx_pacing_evaluated={} audio_tx_pacing_skips={} audio_tx_pacing_skip_ratio_ppm={} \
         audio_tx_pacing_active_max={} audio_tx_pacing_divisor_max={} \
         audio_tx_pacing_consecutive_skip_max={} \
         ...
         audio_rx_packets={} audio_rx_sequence_gap_count={} audio_rx_sequence_gap_packets={} \
         audio_rx_sequence_gap_max_packets={} audio_rx_interarrival_gap_max_us={} \
         audio_rx_jitter_max_us={} audio_rx_decoded_frames={} audio_rx_delivered_frames={} \
         audio_rx_delivered_gap_max_us={}",
            ...
            snapshot.audio_tx_pacing_consecutive_skip_max,
            ...
            snapshot.audio_rx_packet_count,
            snapshot.audio_rx_sequence_gap_count,
            snapshot.audio_rx_sequence_gap_packets,
            snapshot.audio_rx_sequence_gap_max_packets,
            ns_to_us(snapshot.audio_rx_interarrival_gap_max_ns),
            ns_to_us(snapshot.audio_rx_jitter_max_ns),
            snapshot.audio_rx_decoded_frame_count,
            snapshot.audio_rx_delivered_frame_count,
            ns_to_us(snapshot.audio_rx_delivered_gap_max_ns),
        )
    }

    pub fn audio_quality_enabled() -> bool {
        enabled()
            || matches!(
                std::env::var("RVOIP_MEDIA_AUDIO_QUALITY_DIAGNOSTICS").as_deref(),
    ...
    pub fn record_audio_tx_pacing_batch(
        evaluated: u64,
        skips: u64,
        active_max: u64,
        divisor_max: u64,
        consecutive_skip_max: u64,
    ) {
        if evaluated > 0 {
            AUDIO_TX_PACING_EVALUATED_COUNT.fetch_add(evaluated, Ordering::Relaxed);
        }
        if skips > 0 {
        ...
        update_max(&AUDIO_TX_PACING_CONSECUTIVE_SKIP_MAX, consecutive_skip_max);
    }
    ...
    pub fn record_audio_rx_packet(
        sequence_gap_packets: u64,
        interarrival_gap: Option<Duration>,
        jitter: Option<Duration>,
    ) {
        AUDIO_RX_PACKET_COUNT.fetch_add(1, Ordering::Relaxed);
        if sequence_gap_packets > 0 {
            AUDIO_RX_SEQUENCE_GAP_COUNT.fetch_add(1, Ordering::Relaxed);
            AUDIO_RX_SEQUENCE_GAP_PACKETS.fetch_add(sequence_gap_packets, Ordering::Relaxed);
            update_max(&AUDIO_RX_SEQUENCE_GAP_MAX_PACKETS, sequence_gap_packets);
        }
        if let Some(gap) = interarrival_gap {
            AUDIO_RX_INTERARRIVAL_GAP_COUNT.fetch_add(1, Ordering::Relaxed);
            AUDIO_RX_INTERARRIVAL_GAP_NS.fetch_add(ns(gap), Ordering::Relaxed);
            update_max(&AUDIO_RX_INTERARRIVAL_GAP_MAX_NS, ns(gap));
        }
        if let Some(jitter) = jitter {
            update_max(&AUDIO_RX_JITTER_MAX_NS, ns(jitter));
        }
    }

    pub fn record_audio_rx_decoded_frame() {
        AUDIO_RX_DECODED_FRAME_COUNT.fetch_add(1, Ordering::Relaxed);
    }

    pub fn record_audio_rx_delivered_frame(delivery_gap: Option<Duration>) {
        AUDIO_RX_DELIVERED_FRAME_COUNT.fetch_add(1, Ordering::Relaxed);
        if let Some(gap) = delivery_gap {
            AUDIO_RX_DELIVERED_GAP_COUNT.fetch_add(1, Ordering::Relaxed);
            AUDIO_RX_DELIVERED_GAP_NS.fetch_add(ns(gap), Ordering::Relaxed);
            update_max(&AUDIO_RX_DELIVERED_GAP_MAX_NS, ns(gap));
        }
    }
    ...
    fn all_counters() -> [&'static AtomicU64; 58] {
        [
            &MEDIA_START_TOTAL,
            &MEDIA_START_DONE,
            &MEDIA_START_FAIL,
            ...
            &AUDIO_TX_PACING_EVALUATED_COUNT,
            ...
            &AUDIO_RX_PACKET_COUNT,
            &AUDIO_RX_SEQUENCE_GAP_COUNT,
            &AUDIO_RX_SEQUENCE_GAP_PACKETS,
            &AUDIO_RX_SEQUENCE_GAP_MAX_PACKETS,
            &AUDIO_RX_INTERARRIVAL_GAP_COUNT,
            &AUDIO_RX_INTERARRIVAL_GAP_NS,
            &AUDIO_RX_INTERARRIVAL_GAP_MAX_NS,
            &AUDIO_RX_JITTER_MAX_NS,
            &AUDIO_RX_DECODED_FRAME_COUNT,
            &AUDIO_RX_DELIVERED_FRAME_COUNT,
            &AUDIO_RX_DELIVERED_GAP_COUNT,
            &AUDIO_RX_DELIVERED_GAP_NS,
            &AUDIO_RX_DELIVERED_GAP_MAX_NS,
        ]
    }
    ...
    mod tests {
        ...
        fn media_setup_summary_includes_phase_counts() {
            ...
            record_audio_tx_pacing_batch(10, 7, 11, 3, 2);
            record_audio_tx_shared_batch(13, 10, 2, 1, 17);
            record_audio_rx_packet(
                3,
                Some(Duration::from_millis(40)),
                Some(Duration::from_millis(5)),
            );
            record_audio_rx_decoded_frame();
            record_audio_rx_delivered_frame(Some(Duration::from_millis(20)));
            ...
            assert_eq!(snapshot.audio_tx_pacing_evaluated_count, 10);
            assert_eq!(snapshot.audio_tx_pacing_skip_count, 7);
            assert_eq!(snapshot.audio_tx_pacing_active_max, 11);
            assert_eq!(snapshot.audio_tx_pacing_consecutive_skip_max, 2);
            ...
            assert_eq!(snapshot.audio_rx_packet_count, 1);
            assert_eq!(snapshot.audio_rx_sequence_gap_packets, 3);
            assert_eq!(snapshot.audio_rx_decoded_frame_count, 1);
            assert_eq!(snapshot.audio_rx_delivered_frame_count, 1);
            ...
            assert!(summary.contains("audio_tx_pacing_evaluated=10"));
            assert!(summary.contains("audio_tx_pacing_skips=7"));
            assert!(summary.contains("audio_tx_shared_due=13"));
            assert!(summary.contains("audio_rx_packets=1"));
        }
    }
}
...
mod disabled {
    ...
    pub fn format_summary(_: &Snapshot) -> String {
        "[media_setup_diag] disabled".to_string()
    }
    ...
    #[inline(always)]
    pub fn record_rtp_port_allocate(_: Duration) {}

    #[inline(always)]
    pub fn record_rtp_session_new(_: Duration) {}

    #[inline(always)]
    pub fn record_rtp_event_subscription(_: Duration) {}

    #[inline(always)]
    pub fn record_rtp_event_handler_spawn(_: Duration) {}

    #[inline(always)]
    pub fn record_stop_media(_: Duration) {}

    #[inline(always)]
    pub fn record_port_release(_: Duration) {}

    #[inline(always)]
    pub fn record_audio_tx_task_started(_: Duration) {}

    #[inline(always)]
    pub fn record_audio_tx_tick_gap(_: Duration) {}

    #[inline(always)]
    pub fn record_audio_tx_tick_gap_batch(_: u64, _: Duration, _: Duration) {}

    #[inline(always)]
    pub fn record_audio_tx_send(_: Duration, _: bool) {}

    #[inline(always)]
    pub fn record_audio_tx_send_batch(_: u64, _: u64, _: Duration, _: Duration) {}

    #[inline(always)]
    pub fn record_audio_tx_pacing_batch(_: u64, _: u64, _: u64, _: u64, _: u64) {}

    #[inline(always)]
    pub fn record_audio_tx_shared_batch(_: u64, _: u64, _: u64, _: u64, _: u64) {}

    #[inline(always)]
    pub fn record_audio_rx_packet(_: u64, _: Option<Duration>, _: Option<Duration>) {}

    #[inline(always)]
    pub fn record_audio_rx_decoded_frame() {}

    #[inline(always)]
    pub fn record_audio_rx_delivered_frame(_: Option<Duration>) {}
}
