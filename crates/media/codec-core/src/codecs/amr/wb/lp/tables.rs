...
pub const LAG_WINDOW_DPF: [i16; 32] = [
    32750, 16896, 32707, 30464, 32637, 2496,
    32538, 4480, 32411, 12160, 32257, 3520,
    32075, 24320, 31867, 24192, 31633, 20736,
    31374, 576, 31089, 18240, 30780, 31488,
    30449, 128, 30094, 16704, 29718, 11520,
    29321, 14784,
];
