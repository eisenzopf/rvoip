...
**Deliverable location:** [`crates/rvoip-webrtc/docs/HARDENING_PLAN.md`](crates/rvoip-webrtc/docs/HARDENING_PLAN.md)

**Companion doc:** [`docs/IMPLEMENTATION_PLAN.md`](IMPLEMENTATION_PLAN.md) — original phases 0–11 (all marked ✅).

**Scope:** All work lives under `crates/rvoip-webrtc/**`. Cross-crate touches (e.g. `rvoip-websocket` `media-webrtc` feature) only when an in-crate fix cannot stand alone.
