...
`crates/rvoip-sip/tests/perf/`. It is the companion to
...
- `crates/rvoip-sip/benches/` — criterion benches for *relative*
  comparisons (e.g. "did my optimisation help?").
- `crates/rvoip-sip/examples/profiling/` — long-running profiling
