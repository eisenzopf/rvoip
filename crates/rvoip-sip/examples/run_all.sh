...
SCRIPTS=(
  "cargo run -p rvoip-sip --example endpoint_local_call --quiet"
  "cargo run -p rvoip-sip --example endpoint_audio_roundtrip --quiet"
  "cargo run -p rvoip-sip --example endpoint_incoming_redirect --quiet"
  "cargo run -p rvoip-sip --example stream_peer_basic_call --quiet"
  ...
  "cargo run -p rvoip-sip --example unified_basic_call --quiet"
  "cargo run -p rvoip-sip --example unified_event_filters --quiet"
