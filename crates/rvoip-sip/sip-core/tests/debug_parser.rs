use rvoip_sip_core::{error::Error, parse_message};
use std::fs;
            ...
            match message {
                rvoip_sip_core::types::Message::Request(req) => {
                    ...
                    println!(
                        "  From: {}",
                        if req
                            .header(&rvoip_sip_core::types::header::HeaderName::From)
                            .is_some()
                        {
                            "Present"
                        } else {
                    ...
                    println!(
                        "  To: {}",
                        if req
                            .header(&rvoip_sip_core::types::header::HeaderName::To)
                            .is_some()
                        {
                            "Present"
                        } else {
                    ...
                    println!(
                        "  Call-ID: {}",
                        if req
                            .header(&rvoip_sip_core::types::header::HeaderName::CallId)
                            .is_some()
                        {
                            "Present"
                        } else {
                    ...
                    println!(
                        "  CSeq: {}",
                        if req
                            .header(&rvoip_sip_core::types::header::HeaderName::CSeq)
                            .is_some()
                        {
                            "Present"
                        } else {
