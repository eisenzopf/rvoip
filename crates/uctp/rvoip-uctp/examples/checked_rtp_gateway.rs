//! Checked RTP boundary used by a UCTP gateway instead of hand-built headers.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let negotiated = NegotiatedRtpPayload::new(8, RtpCodecKind::Pcma, 8_000)?;
    let inbound = RtpPacket::new_with_payload(8, 7, 160, 0x1234_5678, Bytes::from_static(b"pcma"));
    ...
    assert_eq!(outbound.header.payload_type, 8);
    Ok(())
}
