...
use crate::types::conference::{
    AudioStream, ConferenceMixingConfig, ConferenceMixingEvent, ConferenceMixingStats,
    ParticipantId,
};
...
impl MediaSessionController {
    ...
    pub async fn enable_conference_mixing(&mut self, config: ConferenceMixingConfig) -> Result<()> {
        ...
        // Create audio mixer
        let audio_mixer = Arc::new(
            AudioMixer::new(config.clone())
                .await
        ...
        audio_mixer
            .set_event_sender(self.conference_event_tx.clone())
            .await;
    ...
    pub async fn add_to_conference(&self, dialog_id: &str) -> Result<()> {
        ...
        // Add to mixer
        mixer
            .add_audio_stream(participant_id, audio_stream)
            .await
    ...
    pub async fn remove_from_conference(&self, dialog_id: &str) -> Result<()> {
        ...
        // Remove from mixer
        mixer
            .remove_audio_stream(&participant_id)
            .await
    ...
    pub async fn process_conference_audio(
        &self,
        dialog_id: &str,
        ...
        mixer
            .process_audio_frame(&participant_id, audio_frame)
            .await
        ...
        if active_participants.len() >= 2 {
            ...
            let _mixed_outputs = mixer
                .mix_participants(&empty_inputs)
                .await
    ...
    pub async fn get_conference_mixed_audio(&self, dialog_id: &str) -> Result<Option<AudioFrame>> {
        ...
        mixer
            .get_mixed_audio(&participant_id)
            .await
    ...
    pub async fn take_conference_event_receiver(
        &self,
    ) -> Option<mpsc::UnboundedReceiver<ConferenceMixingEvent>> {
