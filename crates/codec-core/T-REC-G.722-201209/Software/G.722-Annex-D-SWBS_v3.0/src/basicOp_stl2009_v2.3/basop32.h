...
Word16 add (Word16 var1, Word16 var2);    /* Word16 add,           1   */
Word16 sub (Word16 var1, Word16 var2);    /* Word16 sub,           1   */
Word16 abs_s (Word16 var1);               /* Word16 abs,           1   */
Word16 shl (Word16 var1, Word16 var2);    /* Word16 shift left,    1   */
Word16 shr (Word16 var1, Word16 var2);    /* Word16 shift right,   1   */
Word16 mult (Word16 var1, Word16 var2);   /* Word16 mult,          1   */
Word32 L_mult (Word16 var1, Word16 var2); /* Long mult,           1   */
Word16 negate (Word16 var1);              /* Word16 negate,        1   */
...
Word16 norm_s (Word16 var1);             /* Word16 norm,            1  */
Word16 div_s (Word16 var1, Word16 var2); /* Word16 division,       18  */
