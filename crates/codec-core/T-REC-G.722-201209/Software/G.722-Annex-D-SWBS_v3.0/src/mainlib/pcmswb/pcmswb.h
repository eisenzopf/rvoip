...
#define MODE_R4ss    8
#define MODE_R5ss    9
#define MODE_R1ws    10 /* G.722        ,  WB, stereo 8k,  64k */ 
#define MODE_R2ws    11 /* G.722        ,  WB,  stereo 16k, 80k */ 
#endif
...
#ifdef LAYER_STEREO
#define NBITS_MODE_R1ws  320 /* G.722      , WB, stereo 8k, 56k+8k = 64k */
#define NBITS_MODE_R2ws  400 /* G.722      , WB, stereo 16k, 64k+16k = 80k  */
#define NBITS_MODE_R2ss  400 /* G.722      , SWB, stereo 16k, 64k+16k = 80k  */
#define NBITS_MODE_R3ss  480 /* G.722      , SWB, stereo 16k, 80k+16k = 96k  */
#define NBITS_MODE_R4ss  560 /* G.722      , SWB, stereo 16k, 96k+16k = 112k  */
#define NBITS_MODE_R5ss  640 /* G.722      , SWB, stereo 32k, 96k+16k +16k= 128k  */
#endif
...
#ifdef LAYER_STEREO
Word16   pcmswbDecode( unsigned char* bitstream, Word16* outwave, void* p_work, Word16 ploss_status, short *mode, short *highest_mode);
#else
