...
const Word16 nq_table[10]   = {4, 9, 14, 19, 24, 29, 34, 39, 44, 49}; /* 5*nq[i]+4 == bits */
const Word16 mask8[9]   = {0, 1, 3, 7, 15, 31, 63, 127, 255}; /* shl(1,i)-1 */ 
const Word16 Calc_bits[9]   = {0, 0, 9, 14, 19, 24, 29, 34, 39};
const Word16 senv_BWE_table[4] = {32767, 16384, 8192, 4096};
