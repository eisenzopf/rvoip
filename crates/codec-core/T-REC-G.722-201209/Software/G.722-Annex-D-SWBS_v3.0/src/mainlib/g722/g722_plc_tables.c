...
/*HP 100 Hz*/
const Word16 G722PLC_b_hp156[2] = {31456, -31456}; /*0.96, -0.96*/
const Word16 G722PLC_a_hp156[2] = {32767,  28835}; /*1, 0.88*/

/*HP 50 Hz*/
const Word16 G722PLC_b_hp[2] = {32767, -32767}; /*1, -1*/
const Word16 G722PLC_a_hp[2] = {32767,  31488}; /*1, 0.96*/

const Word16 G722PLC_gamma_az[9] = {32767, GAMMA_AZ1, GAMMA_AZ2, GAMMA_AZ3, GAMMA_AZ4,
                                    GAMMA_AZ5, GAMMA_AZ6, GAMMA_AZ7, GAMMA_AZ8}; /*1, 0.96*/
