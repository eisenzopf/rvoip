                           ...
                           )
{
  ...
  FOR (k = 0; k < MDCT2_L_WIN4; k++)
  {
    ACC0 = L_mult0(*ptr2, MDCT_wetrm1_swb[k]);
    ACC0 = L_negate(ACC0);
                 ...
                 )
{
  ...
  ********************************************************************************/
  ...
  FOR (ip = 0; ip < MDCT2_NP; ip++)
  {
    FOR (j = 0; j < MDCT2_NB_REV; j++)
    {
      i = MDCT_tab_rev_i_swb[j];     move16();
      ipp = MDCT_tab_rev_ipp_swb[j]; move16();
  ...
  FOR (ip = 0; ip < MDCT2_NP; ip++)
  {
    FOR (exp_n2 = 0; exp_n2 <= MDCT2_EXP_NPP; exp_n2++)
    {
      ...
      FOR (p = 0; p < n1; p++)
      {
        ...
        IF (sign > 0)            /* FFT */
        {
          FOR (i = p; i < MDCT2_NPP; i = add(i, n2))
          {
