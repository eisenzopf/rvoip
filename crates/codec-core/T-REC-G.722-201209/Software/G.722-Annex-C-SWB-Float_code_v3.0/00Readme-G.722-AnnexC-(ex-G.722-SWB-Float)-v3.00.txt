/*--------------------------------------------------------------------------
 ...
 Software Release 3.00 (2012-09) (same as 1.01, 2012-07, 
 version renumbered for consistency with G.722 3rd edition)

 (C) 2010 France Telecom, Huawei Technologies, NTT, VoiceAge Corp.
--------------------------------------------------------------------------*/

These files represent the ITU-T G.722-SWB Coder Floating-Point C simulation.
...
The folder "test_vector_mswin" and "test_vector_cygwin" contain a set of test vectors
to verify the proper compilation of the reference software.
...
NOTE: Because of the floating-point arithmetic, the processed outputs might not
be bit-exact with the test vectors depending on the platform.
