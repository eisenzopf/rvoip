...
/*
  ...
  ===========================================================================
   ...
   Aug 06      v2.2     Changed to specify frame rate using setFrameRate()
  ============================================================================
*/
...
void WMOPS_output (Word16 dtx_mode, double *average, long *num_frames) {
#if WMOPS
    Word16 i;
    ...
    if (nbframe[currCounter] != 0)
    {
        ...
        *average = tot_wm / (float) nbframe[currCounter];
    }
    fprintf (fp, "  WorstCase=%.3f",
    ...
    if (dtx_mode == 0)
    {
        ...
        fprintf (fp, "  WorstWC=%.3f", ((float) tot_wc) * frameRate);
    }
    fprintf (fp, " (%d frames)\n", nbframe[currCounter]);
