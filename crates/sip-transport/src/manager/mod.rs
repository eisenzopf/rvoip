...
impl TransportManager {
    ...
    pub async fn create_transport(
        ...
        let (transport, rx) = self
            .factory
            .create_transport(transport_type, bind_addr)
            .await?;
    ...
    pub async fn get_transport_for_addr(&self, addr: &SocketAddr) -> Result<Arc<dyn Transport>> {
        ...
        Err(Error::InvalidState(format!(
            "No transport found for address: {}",
            addr
        )))
    }
...
mod tests {
    ...
    async fn test_transport_manager_register() {
        ...
        manager
            .register_transport(Arc::new(transport))
            .await
            .unwrap();
    ...
    async fn test_transport_manager_send() {
        ...
        let server_bound_addr = manager
            .create_transport(TransportType::Udp, server_addr)
            .await
            .unwrap();
        ...
        manager
            .send_message(request.into(), server_bound_addr)
            .await
            .unwrap();
