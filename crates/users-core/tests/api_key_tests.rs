...
use users_core::{ApiKeyStore, CreateUserRequest, SqliteUserStore, UserStore};
...
async fn test_validate_api_key() {
    ...
    let invalid = store
        .validate_api_key("rvoip_ak_live_invalid1234567890")
        .await
        .unwrap();
