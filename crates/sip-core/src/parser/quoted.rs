...
use super::whitespace::{crlf, lws, sws, wsp};
...
mod tests {
    ...
    fn test_unescape_quoted_string() {
        ...
        assert_eq!(
            unescape_quoted_string(b"Hello \\\"Quoted\\\" World"),
            b"Hello \"Quoted\" World"
        );
        assert_eq!(
            unescape_quoted_string(b"\\\\Backslashes\\\\"),
            b"\\Backslashes\\"
        );
        ...
        assert_eq!(
            unescape_quoted_string(b"Line 1\r\n Line 2 with \\\"quotes\\\""),
