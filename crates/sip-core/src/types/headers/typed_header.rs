...
impl TypedHeader {
        ...
        T: std::fmt::Debug,
    {
        ...
        match self {
            TypedHeader::CallId(h)
                if type_id_t == std::any::TypeId::of::<crate::types::CallId>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::From(h)
                if type_id_t == std::any::TypeId::of::<crate::types::from::From>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            ...
            TypedHeader::Via(h)
                if type_id_t == std::any::TypeId::of::<crate::types::via::Via>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            ...
            TypedHeader::ContentLength(h)
                if type_id_t
                    == std::any::TypeId::of::<crate::types::content_length::ContentLength>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::MaxForwards(h)
                if type_id_t == std::any::TypeId::of::<crate::types::MaxForwards>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::Contact(h)
                if type_id_t == std::any::TypeId::of::<crate::types::contact::Contact>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::ContentType(h)
                if type_id_t
                    == std::any::TypeId::of::<crate::types::content_type::ContentType>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::Require(h)
                if type_id_t == std::any::TypeId::of::<crate::types::require::Require>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::Supported(h)
                if type_id_t == std::any::TypeId::of::<crate::types::supported::Supported>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::ContentDisposition(h)
                if type_id_t
                    == std::any::TypeId::of::<
                        crate::types::content_disposition::ContentDisposition,
                    >() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::InReplyTo(h)
                if type_id_t == std::any::TypeId::of::<crate::types::in_reply_to::InReplyTo>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::ReplyTo(h)
                if type_id_t == std::any::TypeId::of::<crate::types::reply_to::ReplyTo>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::Reason(h)
                if type_id_t == std::any::TypeId::of::<crate::types::reason::Reason>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::ErrorInfo(h)
                if type_id_t
                    == std::any::TypeId::of::<crate::types::error_info::ErrorInfoHeader>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::AlertInfo(h)
                if type_id_t
                    == std::any::TypeId::of::<crate::types::alert_info::AlertInfoHeader>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::CallInfo(h)
                if type_id_t == std::any::TypeId::of::<crate::types::call_info::CallInfo>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::Expires(h_inner)
                if type_id_t == std::any::TypeId::of::<crate::types::expires::Expires>() =>
            {
                Some(unsafe { &*(h_inner as *const _ as *const T) })
            }
            TypedHeader::SessionExpires(h)
                if type_id_t
                    == std::any::TypeId::of::<crate::types::session_expires::SessionExpires>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::Event(h)
                if type_id_t == std::any::TypeId::of::<crate::types::event::Event>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::MinSE(h)
                if type_id_t == std::any::TypeId::of::<crate::types::min_se::MinSE>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::RSeq(h)
                if type_id_t == std::any::TypeId::of::<crate::types::rseq::RSeq>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::RAck(h)
                if type_id_t == std::any::TypeId::of::<crate::types::rack::RAck>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
            TypedHeader::ReferTo(h)
                if type_id_t == std::any::TypeId::of::<crate::types::refer_to::ReferTo>() =>
            {
                Some(unsafe { &*(h as *const _ as *const T) })
            }
...
impl fmt::Display for TypedHeader {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            TypedHeader::RecordRoute(record_route) => {
                write!(f, "{}: {}", HeaderName::RecordRoute, record_route)
            }
            TypedHeader::MaxForwards(max_forwards) => {
                write!(f, "{}: {}", HeaderName::MaxForwards, max_forwards)
            }
            TypedHeader::ContentType(content_type) => {
                write!(f, "{}: {}", HeaderName::ContentType, content_type)
            }
            TypedHeader::ContentLength(content_length) => {
                write!(f, "{}: {}", HeaderName::ContentLength, content_length)
            }
            TypedHeader::Expires(expires) => write!(f, "{}: {}", HeaderName::Expires, expires),
            TypedHeader::Authorization(auth) => {
                write!(f, "{}: {}", HeaderName::Authorization, auth)
            }
            TypedHeader::WwwAuthenticate(www_auth) => {
                write!(f, "{}: {}", HeaderName::WwwAuthenticate, www_auth)
            }
            TypedHeader::ProxyAuthenticate(proxy_auth) => {
                write!(f, "{}: {}", HeaderName::ProxyAuthenticate, proxy_auth)
            }
            TypedHeader::ProxyAuthorization(proxy_auth) => {
                write!(f, "{}: {}", HeaderName::ProxyAuthorization, proxy_auth)
            }
            TypedHeader::AuthenticationInfo(auth_info) => {
                write!(f, "{}: {}", HeaderName::AuthenticationInfo, auth_info)
            }
            ...
            TypedHeader::ContentDisposition(cd) => {
                write!(f, "{}: {}", HeaderName::ContentDisposition, cd)
            }
            ...
            TypedHeader::MinExpires(min_expires) => {
                write!(f, "{}: {}", HeaderName::MinExpires, min_expires)
            }
            ...
            TypedHeader::Organization(organization) => {
                write!(f, "{}: {}", HeaderName::Organization, organization)
            }
            ...
            TypedHeader::RetryAfter(retry_after) => {
                write!(f, "{}: {}", HeaderName::RetryAfter, retry_after)
            }
            ...
            TypedHeader::SubscriptionState(state) => {
                write!(f, "{}: {}", HeaderName::SubscriptionState, state)
            }
            ...
            TypedHeader::SessionExpires(session_expires) => {
                write!(f, "{}: {}", HeaderName::SessionExpires, session_expires)
            }
            ...
            TypedHeader::PAssertedIdentity(val) => {
                write!(f, "{}: {}", HeaderName::PAssertedIdentity, val)
            }
    ...
    fn try_from(header: Header) -> Result<Self> {
        ...
        match &header.value {
            ...
            HeaderValue::Accept(values) => {
                ...
                return Ok(TypedHeader::Accept(Accept::from_media_types(
                    values.clone(),
                )));
            }
        ...
        let value_bytes = match &header.value {
            ...
            } // Should not happen if message_header is used
        };
        ...
        let parse_result = match &header.name {
            ...
            HeaderName::RecordRoute => {
                all_consuming(parser::headers::parse_record_route)(value_bytes)
            ...
            HeaderName::Accept => {
                if let HeaderValue::Accept(values) = &header.value {
                    Ok(TypedHeader::Accept(Accept::from_media_types(
                        values.clone(),
                    )))
            ...
            HeaderName::ContentLength => {
                all_consuming(parser::headers::parse_content_length)(value_bytes)
                    .map_err(Error::from)
                    .and_then(|(_, v_u64)| {
                        let length = v_u64.try_into().map_err(|_| {
                            Error::ParseError("Invalid Content-Length value (overflow)".into())
                        })?;
                    ...
                    Ok((_, (disp_type_str, params_vec))) => {
                        ...
                        for param in params_vec {
                            match param {
                                ...
                                DispositionParam::Generic(Param::Other(
                                    name,
            ...
            HeaderName::ContentEncoding => {
                if let HeaderValue::ContentEncoding(values) = &header.value {
                    ...
                    Ok(TypedHeader::ContentEncoding(
                        ContentEncoding::with_encodings(&encodings),
                    ))
                } else if let HeaderValue::Raw(bytes) = &header.value {
            ...
            HeaderName::ContentLanguage => {
                if let HeaderValue::ContentLanguage(values) = &header.value {
                    ...
                    Ok(TypedHeader::ContentLanguage(
                        ContentLanguage::with_languages(&languages),
                    ))
                } else if let HeaderValue::Raw(bytes) = &header.value {
            ...
            HeaderName::MaxForwards => {
                all_consuming(parser::headers::parse_max_forwards)(value_bytes)
                    .map_err(Error::from)
                    .and_then(|(_, v_u32)| {
                        let forwards = v_u32.try_into().map_err(|_| {
                            Error::ParseError("Invalid Max-Forwards value (overflow)".into())
                        })?;
            ...
            HeaderName::MinExpires => {
                all_consuming(parser::headers::parse_min_expires)(value_bytes)
                    .map_err(Error::from)
                    .and_then(|(_, v_u32)| {
                        MinExpires::from_str(&v_u32.to_string()).map(TypedHeader::MinExpires)
                    })
            }
            HeaderName::MimeVersion => {
                all_consuming(parser::headers::parse_mime_version)(value_bytes)
                    .map_err(Error::from)
                    .map(|(_, parsed_version_u8)| {
                        TypedHeader::MimeVersion(crate::types::mime_version::MimeVersion::new(
            ...
            HeaderName::WwwAuthenticate => {
                ...
                if let HeaderValue::WwwAuthenticate(_) = &header.value {
                    return Err(Error::InternalError(
                        "HeaderValue::WwwAuthenticate should have been handled in special cases"
                            .to_string(),
                    ));
                }
            ...
            HeaderName::Authorization => {
                ...
                if let HeaderValue::Authorization(_) = &header.value {
                    return Err(Error::InternalError(
                        "HeaderValue::Authorization should have been handled in special cases"
                            .to_string(),
                    ));
                }
            ...
            HeaderName::ProxyAuthenticate => {
                all_consuming(parser::headers::parse_proxy_authenticate)(value_bytes)
                    .map(|(_, v)| TypedHeader::ProxyAuthenticate(ProxyAuthenticate(v)))
                    .map_err(Error::from)
            }
            HeaderName::ProxyAuthorization => {
                all_consuming(parser::headers::parse_proxy_authorization)(value_bytes)
                    .map(|(_, v)| TypedHeader::ProxyAuthorization(ProxyAuthorization(v)))
                    .map_err(Error::from)
            }
            HeaderName::AuthenticationInfo => {
                all_consuming(parser::headers::parse_authentication_info)(value_bytes)
            ...
            HeaderName::Unsupported => {
                all_consuming(parser::headers::unsupported::parse_unsupported)(value_bytes)
                    .map(|(_, strings)| TypedHeader::Unsupported(Unsupported::with_tags(strings)))
                    .map_err(Error::from)
            }
            HeaderName::ProxyRequire => {
                all_consuming(parser::headers::parse_proxy_require)(value_bytes)
                    .map(|(_, strings)| {
                        TypedHeader::ProxyRequire(
                            crate::types::proxy_require::ProxyRequire::from_strings(strings),
                        )
                    })
                    .map_err(Error::from)
            }
            ...
            HeaderName::Organization => {
                all_consuming(parser::headers::parse_organization)(value_bytes)
                    .map(|(_, org)| TypedHeader::Organization(org))
                    .map_err(Error::from)
            }
            HeaderName::Priority => all_consuming(parser::headers::parse_priority)(value_bytes)
                .map(|(_, priority)| {
                    TypedHeader::Priority(
                        crate::types::priority::Priority::from_str(&priority.to_string())
                            .unwrap_or(crate::types::priority::Priority::Normal),
                    )
                })
                .map_err(Error::from),
            HeaderName::Subject => {
            ...
            HeaderName::InReplyTo => all_consuming(parser::headers::parse_in_reply_to)(value_bytes)
                .map(|(_, strings)| {
                    TypedHeader::InReplyTo(
                        crate::types::in_reply_to::InReplyTo::with_multiple_strings(strings),
                    )
                })
                .map_err(Error::from),
            HeaderName::Warning => {
                ...
                if let Ok(s) = std::str::from_utf8(value_bytes) {
                    if let Ok(warning_header) =
                        crate::types::warning::WarningHeader::from_str(s.trim())
                    {
                ...
                let parse_result =
                    all_consuming(parser::headers::warning::parse_warning_value_list)(value_bytes);
                match parse_result {
                    Ok((_, parsed_values)) => {
                        let mut typed_warnings = Vec::new();
                        for parsed_value in parsed_values {
                            let agent_uri = match parsed_value.agent {
                                WarnAgent::HostPort(host, _port_opt) => Uri::new(Scheme::Sip, host),
                            ...
                            let text_string = String::from_utf8(parsed_value.text.to_vec())
                                .map_err(|e| {
                                    Error::ParseError(format!(
                                        "Invalid UTF-8 in warning text: {}",
                                        e
                                    ))
                                })?;

                            typed_warnings.push(Warning::new(
                                parsed_value.code,
                                agent_uri,
                                text_string,
                            ));
                ...
                if let HeaderValue::Raw(bytes) = &header.value {
                    ...
                    match all_consuming(parser::headers::error_info::parse_error_info)(bytes) {
                        Ok((_, error_info_values)) => {
                            ...
                            return Ok(TypedHeader::ErrorInfo(ErrorInfoHeader {
            ...
            HeaderName::AlertInfo => all_consuming(parser::headers::parse_alert_info)(value_bytes)
                .map(|(_, alert_info_values)| {
                    ...
                    for value in alert_info_values {
                        if let Ok(alert_info) =
                            crate::types::alert_info::AlertInfoHeader::from_alert_info_value(&value)
                        {
                            alert_info_list.add(alert_info);
                        }
                    }
                    TypedHeader::AlertInfo(crate::types::alert_info::AlertInfoHeader {
                        alert_info_list,
                    })
                })
                .map_err(Error::from),
            ...
            HeaderName::ServiceRoute => {
                if let HeaderValue::Raw(bytes) = &header.value {
                    if let Ok(s) = std::str::from_utf8(bytes) {
                        ...
                        Err(Error::InvalidHeader(format!(
                            "Invalid UTF-8 in Service-Route header"
                        )))
                    }
                } else if let HeaderValue::Route(entries) = &header.value {
            ...
            HeaderName::SessionExpires => all_consuming(parse_session_expires)(value_bytes)
                .map(|(_, (delta, refresher, params))| {
                    TypedHeader::SessionExpires(SessionExpires::new_with_params(
                        delta, refresher, params,
                    ))
                })
                .map_err(Error::from),
            HeaderName::Event => {
                ...
                let value_str = std::str::from_utf8(value_bytes).map_err(|e| {
                    Error::ParseError(format!("Invalid UTF-8 in Event header value: {}", e))
                })?;
            ...
            HeaderName::SubscriptionState => {
                ...
                let value_str = std::str::from_utf8(value_bytes).map_err(|e| {
                    Error::ParseError(format!(
                        "Invalid UTF-8 in Subscription-State header value: {}",
                        e
                    ))
                })?;
            ...
            HeaderName::MinSE => {
                let value_str = std::str::from_utf8(value_bytes).map_err(|e| {
                    Error::ParseError(format!("Invalid UTF-8 in MinSE header value: {}", e))
                })?;
                Ok(TypedHeader::MinSE(MinSE::from_str(value_str)?))
            }
            HeaderName::RSeq => {
                let value_str = std::str::from_utf8(value_bytes).map_err(|e| {
                    Error::ParseError(format!("Invalid UTF-8 in RSeq header value: {}", e))
                })?;
                Ok(TypedHeader::RSeq(crate::types::rseq::RSeq::from_str(
                    value_str,
                )?))
            }
            HeaderName::RAck => {
                let value_str = std::str::from_utf8(value_bytes).map_err(|e| {
                    Error::ParseError(format!("Invalid UTF-8 in RAck header value: {}", e))
                })?;
                Ok(TypedHeader::RAck(crate::types::rack::RAck::from_str(
                    value_str,
                )?))
            }
            HeaderName::SipETag => {
