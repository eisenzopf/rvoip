...
mod tests {
    ...
    fn test_valid_extmap_different_uris() {
        ...
        assert_eq!(
            parse_extmap(urn_complex).unwrap().2,
        ...
        assert_eq!(
            parse_extmap(http_uri).unwrap().2,
