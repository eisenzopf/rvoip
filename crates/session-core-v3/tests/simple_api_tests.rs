...
use rvoip_session_core_v3::api::unified::Config;
use rvoip_session_core_v3::StreamPeer;
use rvoip_session_core_v3::SessionId;
...
async fn test_hold_resume_call_via_coordinator() {
    ...
    let coordinator = rvoip_session_core_v3::UnifiedCoordinator::new(config).await.unwrap();
