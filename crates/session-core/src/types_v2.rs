//! Core types for session-core v2 modules (merged into v1)
//!
//! This module defines the fundamental types used by the v2 modules.
//! It re-exports types from state_table and api_v2 as needed.
...
pub use crate::state_table::types::{SessionId, DialogId, MediaSessionId, CallState, FailureReason};

// Re-export types from api_v2::types for backwards compatibility
// (only available when api_v2 is compiled)
// pub use crate::api_v2::types::{...};
