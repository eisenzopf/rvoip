...
//! Run with:
//!
//!   cargo run -p rvoip-session-core --example endpoint_audio_roundtrip
//!
...
use rvoip_session_core::{Config, Endpoint, EndpointAudioFrame, EndpointCall, EndpointProfile};
...
async fn build_endpoint(
    ...
    media_start: u16,
    media_end: u16,
) -> rvoip_session_core::Result<Endpoint> {
