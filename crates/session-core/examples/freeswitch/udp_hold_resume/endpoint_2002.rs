//! FreeSWITCH UDP hold/resume endpoint 2002: register, answer 2001, send a steady
...
async fn main() -> ExampleResult<()> {
    ...
    if expect_remote_hold_events()? {
        ...
        println!(
            "[2002] Remote hold/resume event assertion disabled; set FREESWITCH_EXPECT_REMOTE_HOLD_EVENTS=1 for PBX profiles that forward hold re-INVITEs."
        );
    }
