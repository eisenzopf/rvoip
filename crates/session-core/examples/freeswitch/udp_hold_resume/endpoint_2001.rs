//! FreeSWITCH UDP hold/resume endpoint 2001: register, call 2002, hold, resume,
...
use common::{
    ...
    save_wav, send_tone_segment, wait_for_local_hold_on_events, wait_for_local_resume_on_events,
    ExampleResult,
};
