//! Analyze the WAV files generated by the FreeSWITCH hold/resume example.
...
use common::{
    ...
    load_env, print_analysis, read_wav, ExampleResult, ENDPOINT_2001_TONE_HZ,
    ENDPOINT_2002_TONE_HZ, SAMPLE_RATE,
};
...
fn main() -> ExampleResult<()> {
    ...
    println!("=== FreeSWITCH hold/resume audio analysis ===");
    print_analysis(
