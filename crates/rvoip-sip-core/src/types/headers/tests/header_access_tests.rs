...
mod tests {
    ...
    fn create_test_request() -> Request {
        ...
        Request::new(Method::Invite, uri)
            .with_header(TypedHeader::From(From::new(
                Address::new_with_display_name("Alice", "sip:alice@example.com".parse().unwrap()),
            )))
            ...
            .with_header(TypedHeader::Via(Via(vec![
                ViaHeader {
                    ...
                    params: vec![Param::new(
                        "branch".to_string(),
                        Some("z9hG4bK776asdhds".to_string()),
                    )],
                },
                ViaHeader {
                    sent_protocol: SentProtocol {
    ...
    fn test_raw_header_value() {
        ...
        assert!(call_id_value
            .unwrap()
            .contains("a84b4c76e66710@pc33.atlanta.com"));
    }
