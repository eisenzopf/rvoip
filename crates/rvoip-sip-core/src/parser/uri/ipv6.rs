    ...
    map_res(
        ...
        |bytes| {
            str::from_utf8(bytes)
                ...
                }) // Verify ensures valid IPv6 syntax
                .map(Host::Address)
        },
    )(input)
}
...
mod tests {
    ...
    fn test_ipv6_reference_standard() {
        ...
        assert_eq!(
            host,
            Host::Address(IpAddr::V6(Ipv6Addr::new(0x2001, 0xdb8, 0, 0, 0, 0, 0, 1)))
        );
    ...
    fn test_ipv6_reference_special_forms() {
        ...
        assert_eq!(
            host,
            Host::Address(IpAddr::V6(Ipv6Addr::new(0, 0, 0, 0, 0, 0, 0, 1)))
        );
        ...
        assert_eq!(
            host,
            Host::Address(IpAddr::V6(Ipv6Addr::new(0, 0, 0, 0, 0, 0, 0, 0)))
        );
    ...
    fn test_ipv6_reference_rfc_examples() {
        ...
        assert_eq!(
            host,
            Host::Address(IpAddr::V6(Ipv6Addr::new(0x2001, 0xdb8, 0, 0, 0, 0, 9, 1)))
        );
        ...
        assert_eq!(
            host,
            Host::Address(IpAddr::V6(Ipv6Addr::new(0xfe80, 0, 0, 0, 0, 0, 0, 1)))
        );
        ...
        assert_eq!(
            host,
            Host::Address(IpAddr::V6(Ipv6Addr::new(0xfec0, 0, 0, 0, 0, 0, 0, 1)))
        );
        ...
        assert_eq!(
            host,
            Host::Address(IpAddr::V6(Ipv6Addr::new(
