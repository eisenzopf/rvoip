...
//! how to access the various components of a SIP message, and how to create SIP
//! messages with SDP content using the builder pattern.
...
fn main() {
    ...
    // Example 4: Create SIP messages with SDP content using builder pattern
    create_sip_sdp_with_builder();
...
/// Example 4: Create SIP messages with SDP content using builder pattern
fn create_sip_sdp_with_builder() {
