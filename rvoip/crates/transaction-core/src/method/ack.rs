...
//!
//! Implements special handling for ACK requests according to RFC 3261 Section 17.1.1.3.
...
///
/// According to RFC 3261, ACK for non-2xx final responses:
