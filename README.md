...
| Opus | 🚧 Alpha optional | Real Opus (RFC 6716) codec in `rvoip-codec-core` via the `opus` feature, using `opus-rs` (pure Rust); not yet wired into media-core SDP negotiation |
| G.722 | 🔮 Post-beta | Codec hooks exist; full-media path is post-beta |
...
│  rvoip-codec-core   (✅ beta)  G.711 + opt. G.729A/AB + Opus  │
...
| [rvoip-codec-core](crates/media/codec-core) | G.711 plus optional G.729A/G.729AB and Opus codec implementations |
